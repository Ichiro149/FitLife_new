{{-- Šis izkārtojuma skats veido "layouts app" kopējo lapas struktūru. --}}
...
@php
    ...
    $toastMessages = [
        ...
        'post_image_too_large' => __('toast.post_image_too_large'),
        'post_image_prepare_error' => __('toast.post_image_prepare_error'),
        'post_video_too_large' => __('toast.post_video_too_large'),
...
<body class="{{ $hideMobileNav ? 'layout-mobile-nav-hidden' : '' }} {{ $flushMobileContent ? 'layout-mobile-content-flush' : '' }}" data-toast-messages='@json($toastMessages)'>
    ...
    <header class="main-header" id="mainHeader">
        <div class="header-container">
            ...
            <div class="header-thesis-badge" tabindex="0" aria-describedby="headerDemoTooltip" aria-label="{{ __('nav.thesis_demo_hint') }}">
                ...
                <span class="header-thesis-badge__label">{{ __('nav.thesis_demo_badge') }}</span>
                <div class="header-thesis-badge__tooltip" id="headerDemoTooltip" role="tooltip">
                    <strong>{{ __('nav.thesis_demo_badge') }}</strong>
                    <span>{{ __('nav.thesis_demo_hint') }}</span>
                </div>
            </div>
