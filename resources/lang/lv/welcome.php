...
return [
    ...
    'feature_nutrition_title' => 'Gudra uztura plānošana',
    'feature_nutrition_desc' => 'Reģistrējiet maltītes, aprēķiniet makroelementus un saņemiet personalizētus uztura plānus ar receptēm.',
    'feature_nutrition_alt' => 'Veselīga maltīte',

    'feature_sleep_title' => 'Veselīgs miegs',
    'feature_sleep_desc' => 'Uzraugiet miega modeļus un saņemiet ieskatus optimālai atjaunošanai.',
    'feature_sleep_alt' => 'Mierīga guļamistaba',

    'feature_community_title' => 'Dinamiska kopiena',
    'feature_community_desc' => 'Pievienojieties atbalstošam tīklam, lai dalītos ar mērķiem un piedalītos izaicinājumos.',
    'feature_community_alt' => 'Grupu vingrinājumi',

    'feature_progress_title' => 'Progresa izsekošana',
    'feature_progress_desc' => 'Vizualizējiet savu ceļojumu ar progresa diagrammām un analītiku.',
    'feature_progress_alt' => 'Progresa izsekošanas panelis',

    'feature_goals_title' => 'Mērķu izvirzīšana',
    ...
    'testimonial_1_text' => '"FitLife padarīja fitnesu jautru. Es zaudēju 7 kg!"',
    'testimonial_1_author' => '- Anna K.',

    'testimonial_2_text' => '"Uztura izsekotājs ir revolucionārs."',
    'testimonial_2_author' => '- Marks S.',
